...
int user_initialize()
{
    ...
    status = ProMenubarmenuPushbuttonAdd("IMI_Mainmenu", "IMI_ExportFamInstsmenu", "IMI_ExportFamInstsmenu", "IMI_ExportFamInstsmenutips", NULL, PRO_B_TRUE, IMI_ExportFamInstsID, MSGFILE);
