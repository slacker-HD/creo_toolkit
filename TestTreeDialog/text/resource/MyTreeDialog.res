...
(Layout Content
    ...
    (Resources
        (MyTree.TopOffset 0)
        (MyTree.BottomOffset 0)
        (MyTree.LeftOffset 0)
        (MyTree.RightOffset 0)
        (MyTree.ListType 3)
        (MyTree.AutoOpen True)
        (MyTree.Selected_image "UI Cascade unsel image")
        (MyTree.ShowGrid True)
        (MyTree.TreeAttributeWindow True)
        (MyTree.SelectByCell True)
        (.AttachLeft True)
        (.AttachRight True)
        (.AttachTop True)
        (.TopOffset 16)
